...
The last section that we are looking at is Monthly Recurring Subscriptions. This is a metric showing the dollar amount that we are earning each month through subscriptions. This isn’t necessarily a sign of how much money we are earning but is something you can look at to see what the platform is bringing in for subs before expenses. The chart can be found here [https://glimesh.tv/about/open-data](https://glimesh.tv/about/open-data)
...
As seen here we had a drop in one platform subscription. This number will hopefully in the future continue to move upward. Once subs are unlocked we will see this number change more but as right now there is just a group of test users working on the payments while we work out any bugs or other details.
...
**Maybe include Quickdrops logo here if we have permission???**
...
Chameolabs is developing software for use with Glimesh that allows streamers to use  widgets, alerts, a cloudbot and more. This week Dantiwire posted a video in Discord showing us their alerts working. We can’t wait to see how this develops!
